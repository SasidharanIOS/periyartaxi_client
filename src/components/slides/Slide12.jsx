      ...
      >
        ...
        <motion.div variants={item} className="flex-shrink-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end gap-2 flex-wrap">
            ...
            >
              APP FEATURES{" "}
              <span style={{ color: LT.amber }}>& TECH</span>
            </h2>
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              >
                ...
                <span
                  ...
                  style={{ fontSize: "clamp(10px,1vw,13px)", color: "#16a34a" }}
                >
                  Android
                </span>
              </div>
              ...
              >
                ...
                <span
                  className="font-body font-semibold"
                  style={{ fontSize: "clamp(10px,1vw,13px)", color: LT.text }}
                >
                  iOS
                </span>
              </div>
        ...
        <div
          className="flex-1 grid grid-cols-2 md:grid-cols-3 min-h-0"
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between relative z-10 mt-0.5">
                  ...
                  <span
                    className="font-body font-bold uppercase tracking-widest px-2 py-0.5 rounded-full"
                    style={{
                ...
                <div className="relative z-10">
                  <h3
                    className="font-body font-bold leading-tight mb-0.5"
                    style={{ fontSize: "clamp(11px,1.3vw,16px)", color: LT.text }}
                  >
                    {f.title}
                  </h3>
                  <p
                    className="font-body leading-snug hidden sm:block"
                    style={{ fontSize: "clamp(9px,1vw,13px)", color: LT.textMuted }}
                  >
                    {f.desc}
                  </p>
                  <p
                    className="font-body leading-snug block sm:hidden"
                ...
                <div
                  className="absolute bottom-0 left-0 w-8 h-8 rounded-tr-2xl opacity-[0.07] pointer-events-none"
                  style={{ background: f.accent }}
                />
              </motion.div>
            );
